...
function GlassCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -2 }}
      className={`relative overflow-hidden rounded-[30px] backdrop-blur-xl ${className}`}
      style={{
        background: 'linear-gradient(135deg,#ffffff 0%,#f8fafc 100%)',

        border: '1px solid #e2e8f0',

        boxShadow: hovered ? '0 12px 32px rgba(15,23,42,.08)' : '0 6px 18px rgba(15,23,42,.05)',
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(90deg, transparent, rgba(83,115,165,0.35), transparent)',
        }}
      />
...
function LiveMapCard() {
  ...
  return (
    <GlassCard delay={0} glowColor="rgba(6,182,212,0.15)" className="min-h-[420px]">
      {/* Header */}
      <div className="flex items-center justify-between px-5 pb-2 pt-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2
              className="text-base font-bold leading-tight text-[#0f172a]"
        ...
        <div className="flex items-center gap-2">
          <button
            className="flex h-8 w-8 items-center justify-center rounded-xl text-[#94a3b8] transition-colors hover:text-[#5373a5]"
            style={{
              background: 'rgba(255,255,255,0.04)',
              border: '1px solid rgba(255,255,255,0.08)',
            }}
          >
            <span className="mb-0.5 text-lg font-bold leading-none">+</span>
          </button>
          <button
            className="flex h-8 w-8 items-center justify-center rounded-xl text-[#94a3b8] transition-colors hover:text-[#5373a5]"
            style={{
      ...
      {/* Map body */}
      <div className="relative mx-4 mb-4 overflow-hidden rounded-2xl" style={{ height: '290px' }}>
        {/* Dark map background */}
        <svg width="100%" height="100%" viewBox="0 0 640 340" className="absolute inset-0">
          ...
          {[
            ...
            <path key={i} d={d} stroke="rgba(226,232,240,0.22)" strokeWidth="6" fill="none" />
          ))}
          {[
            'M 0 170 Q 200 160 320 180 Q 440 200 640 170',
            'M 0 260 L 640 240',
          ...
          <text x="510" y="205" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold">
            H
          </text>
          ...
          <g transform={`translate(${pathPoints.x - 14}, ${pathPoints.y - 9})`}>
            ...
            <text x="14" y="14" textAnchor="middle" fill="white" fontSize="6" fontWeight="bold">
              🚑
            </text>
            <motion.rect
              x="4"
        ...
        {/* Legend overlay */}
        <div
          className="absolute bottom-3 left-3 rounded-xl p-3"
          style={{
        ...
        <motion.div
          ...
          className="absolute right-3 top-3 rounded-2xl p-4"
          style={{
        ...
        >
          ...
          <p className="mb-1 text-xs text-[#94a3b8]">Ambulance is on the way</p>
          <p
            className="mb-0.5 text-3xl font-black text-[#0f172a]"
            style={{ fontFamily: 'Rajdhani, sans-serif' }}
          >
            6 mins
          </p>
          <p className="mb-3 text-xs text-[#64748b]">Estimated Arrival Time</p>

          <div className="border-t border-slate-800 pt-3">
            <p className="mb-1 text-xs text-[#64748b]">Patient</p>
            <p className="text-sm font-bold text-[#0f172a]">Rohan Verma, 24 M</p>
          </div>

          <motion.button
            whileHover={{ scale: 1.03 }}
            whileTap={{ scale: 0.97 }}
            className="mt-3 flex w-full items-center justify-center gap-1.5 rounded-xl py-2 text-xs font-bold text-[#0f172a]"
          ...
          <div className="mt-3 border-t border-slate-800 pt-2">
            <div className="flex items-center justify-between">
              <span className="text-xs text-[#64748b]">Green Corridor</span>
            ...
            <p className="text-xs text-[#64748b]">Traffic signals optimized ahead</p>
          </div>
        </motion.div>
      </div>
    </GlassCard>
    ...
    >
      <div className="flex h-full flex-col p-4">
        ...
        <div className="mb-3 flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#64748b]">Based on your symptoms</p>
            </div>
          </div>
          {/* High Priority Badge */}
          <motion.div
        ...
        >
          ...
          />
          <p className="mb-3 text-xs font-semibold uppercase tracking-[0.22em] text-[#94a3b8]">
            Symptoms Detected
          </p>
        ...
        <div className="mb-5 flex items-center justify-between">
          <div>
            <p className="mb-2 text-xs uppercase tracking-[0.22em] text-[#64748b]">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-[#0f172a]">Cardiologist</p>
                <p className="text-xs text-emerald-400">Available Now</p>
              </div>
            </div>
          </div>
          <div className="flex flex-col items-center gap-1">
            <p className="mb-1 text-xs uppercase tracking-[0.22em] text-[#64748b]">AI Confidence</p>
        ...
        <div className="mt-4 grid grid-cols-3 gap-2">
          {[
            ...
            >
              ...
              <p
                className="text-base font-black leading-tight text-[#0f172a]"
                style={{ fontFamily: 'Rajdhani, sans-serif', color }}
              >
                {value}
              </p>
              <p className="text-xs text-[#64748b]">{unit}</p>
              <p className="mt-0.5 text-xs leading-tight text-[#64748b]">{label}</p>
            </div>
          ))}
        </div>
      </div>
...
function Avatar({
  ...
  return (
    <motion.div
      ...
      className="relative flex items-center justify-center rounded-full font-black text-[#0f172a]"
      style={{
        width: size,
        height: size,
...
function StarRating({ rating }: { rating: number }) {
  return (
    <div className="flex items-center gap-1">
      ...
      <span className="ml-1 text-xs font-bold text-amber-400">{rating}</span>
    </div>
  );
}
...
function PersonnelCard({
  ...
  return (
    <motion.div
      ...
      style={{
        background: 'rgba(255,255,255,0.18)',
        border: hovered ? '1px solid rgba(6,182,212,0.3)' : '1px solid rgba(226,232,240,0.16)',
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="mb-1 text-xs text-[#94a3b8]">{specialty}</p>
      ...
      <div className="flex h-full flex-col p-4">
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#64748b]">Emergency Response Team</p>
          </div>
        </div>
        ...
        >
          ...
          <p className="text-xs font-semibold leading-snug text-emerald-300">
        ...
        <div className="mt-auto border-t border-slate-800 pt-3">
          ...
          <div className="relative">
            <div
              className="absolute bottom-0 left-3 top-0 w-0.5 rounded-full"
            ...
            {[
              ...
              <div key={label} className="relative mb-3 flex items-center gap-4 pl-8">
                <div
                  className="absolute left-1.5 flex h-3 w-3 items-center justify-center rounded-full border-2"
                  style={{
                ...
                <div className="flex-1">
                  <p
                    className={`text-xs font-semibold ${done ? 'text-[#0f172a]' : 'text-[#5373a5]'}`}
                  >
                    {label}
                  </p>
                </div>
...
function AnalyticsCard({
  ...
  return (
    <motion.div
      ...
      onHoverStart={() => setHovered(true)}
      onHoverEnd={() => setHovered(false)}
      className="relative min-h-[115px] cursor-pointer overflow-hidden rounded-3xl p-4"
      style={{
        background:
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(circle at 20% 80%, ${color}0a 0%, transparent 60%)`,
      ...
      <div className="relative z-10">
        ...
        <motion.p
          className="mb-0.5 text-2xl font-black text-[#0f172a]"
          style={{
            fontFamily: 'Rajdhani, sans-serif',
        ...
        <p className="mb-0.5 text-xs text-[#64748b]">{unit}</p>
        ...
        <div className="grid grid-cols-2 gap-3">
          {services.map(({ label, color, bg, Icon }) => (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex flex-col items-center justify-center gap-3 rounded-2xl p-4 min-h-[110px]"
            ...
            >
              ...
              <span
                className="text-center text-xs font-medium leading-tight text-[#4B5563]"
                style={{ fontSize: '11px' }}
              >
                {label}
              </span>
    ...
    <GlassCard delay={0.25} glowColor="rgba(239,68,68,0.08)" borderColor="rgba(239,68,68,0.15)">
      <div className="p-5">
        <div className="mb-4 flex items-center justify-between">
          ...
          <button className="flex items-center gap-0.5 text-xs font-semibold text-[#5373a5] transition-colors hover:text-[#6d86ad]">
          ...
          {alerts.map(({ icon: Icon, label, sub, time, color }, i) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate text-xs font-semibold text-[#0f172a]">{label}</p>
                <p className="truncate text-xs text-[#64748b]">{sub}</p>
              </div>
              <span className="flex-shrink-0 whitespace-nowrap text-xs text-slate-600">{time}</span>
            </motion.div>
          ))}
        </div>
      </div>
...
export default function EmergencyCommandCenter() {
  return (
    <section
      className="relative w-full space-y-5 overflow-hidden px-0 md:px-0"
      style={{
    ...
    >
      ...
      <div
        className="pointer-events-none absolute inset-0"
        style={{
          background: 'linear-gradient(rgba(255,255,255,0.04), rgba(0,0,0,0.02))',
        }}
      />

      {/* ambient glow */}
      <div
        className="absolute -right-40 -top-40 h-[420px] w-[420px] rounded-full opacity-30 blur-3xl"
        style={{
      ...
      <div
        className="absolute bottom-0 left-0 h-[320px] w-[320px] rounded-full opacity-20 blur-3xl"
        style={{
      ...
      <motion.div
        ...
        className="relative z-10 mb-4 flex items-center gap-3 px-1"
      >
        <div className="flex items-center gap-2">
          <motion.div
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(90deg, rgba(83,115,165,0.45), transparent)',
          }}
        />
      </motion.div>
