  ...
  return (
    <div className="flex items-center gap-3 px-5 py-5 border-b border-white/[0.06]">
      ...
      <div className="relative flex-shrink-0 h-10 w-10 rounded-2xl flex items-center justify-center"
           style={{ background: "linear-gradient(135deg,#2563eb,#06b6d4)", boxShadow: "0 0 18px rgba(37,99,235,.35)" }}>
        {/* ECG line */}
      ...
      <div className="leading-none">
        <p className="text-[15px] font-extrabold tracking-wide text-white">
          LifeLine <span style={{ color: "#60a5fa" }}>AI</span>
        </p>
...
function SidebarItem({ item, active }: { item: NavItem; active: boolean }) {
  ...
  active
    ? {
        background:
"linear-gradient(90deg,#1D8BFF 0%,#2563EB 100%)",
...
function SystemStatus() {
  return (
    <div className="mx-4 mt-3 mb-2 rounded-xl px-3 py-3"
         style={{ background: "rgba(255,255,255,.04)",boxShadow: "0 8px 20px rgba(0,0,0,.15)", border: "1px solid rgba(255,255,255,.06)" }}>
  ...
  return (
    <div className="mx-4 mb-5 mt-2">
      <button
        ...
        style={{ background:
"linear-gradient(135deg,#7f1d1d,#991b1b)", border: "1px solid rgba(248,113,113,.3)" }}
      ...
      >
        ...
        <div className="text-left">
          ...
          <p className="text-2xl font-black leading-none" style={{ color: "#ffffff" }}>108</p>
        </div>
      </button>
    </div>
  );
...
function Sidebar({
  ...
  return (
    <>
      {/* Desktop */}
      <aside
  className="hidden lg:flex fixed left-0 top-0 h-screen w-[270px] flex-col z-40"
        style={{
          background:
"linear-gradient(180deg,#001B4D 0%,#002A66 45%,#00163D 100%)",
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.aside
            ...
            className="fixed left-0 top-0 bottom-0 w-[270px] z-50 flex flex-col lg:hidden"
            style={{
              background:
"linear-gradient(180deg,#04152d 0%,#051b3f 50%,#031126 100%)",
              borderRight: "1px solid rgba(255,255,255,0.08)",
            }}
          >
            ...
            {ALERTS.map((a, i) => (
              <div key={i}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] truncate" style={{ color: "#d1d5db" }}>{a.sub}</p>
                </div>
